...
report.switchTab("check-out-list-report", { reset: false, fetchNow: false });
...
async function onSearch() {
  report.replaceFilters(payload.value, "check-out-list-report");
  await report.fetch();
}

async function syncAndFetch(patch) {
  report.replaceFilters(patch, "check-out-list-report");
  await report.fetch();
}
