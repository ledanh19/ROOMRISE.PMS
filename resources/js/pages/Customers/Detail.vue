      ...
      <div class="d-flex align-center justify-space-between flex-wrap">
        <div class="header-content">
          ...
          <p class="text-medium-emphasis text-subtitle-1">
            Quản lý và theo dõi thông tin khách hàng và các thanh toán đặt phòng
          </p>
        </div>
      </div>
    </div>
                      ...
                      >
                        <VCardTitle class="d-flex align-center mb-3">
                          ...
                          <VChip
                            ...
                            variant="elevated"
                          >
                            {{ booking.income_expenses?.length || 0 }} giao dịch
                          </VChip>
                        </VCardTitle>
                        <VCardText>
                          <div
                            v-if="
                              ...
                              booking.income_expenses.length > 0
                            "
                            class="payment-list"
                          >
                            <div
                              v-for="payment in booking.income_expenses"
                              :key="payment.id"
